...
{
public:
	//писал для лабы с паттернами, посмотри, надо оно или нет.
	//Теперь у нас много будет приходить данных от пользователей, то есть не одно нажатие из одной функции, а целая куча из буста.
	//Так что может оставить...
