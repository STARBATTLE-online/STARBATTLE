...
public:
	...
	void GetRotationByMouse(int x_mouse, int y_mouse) {
		//тут были услови€ относительно окна, они не кат€т, надо относительно корабл€
		if (true) {
			if (true)
	...
	//“от же "Ќаблюдатель". ≈сли не надо - убирай
...
//ѕулек может быт много, надо не забывать удал€ть
