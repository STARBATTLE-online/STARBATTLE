...
public:
	Frame(){
		...
		frame_elements[Elements::bottom].height = 199;
		frame_elements[Elements::bottom].width = 820;

		frame_elements[Elements::top].symbol = createSprite("data/frame/side_top.png");
		frame_elements[Elements::top].height = 199;
		frame_elements[Elements::top].width = 820;

		frame_elements[Elements::top].symbol = createSprite("data/frame/side_left.png");
		frame_elements[Elements::top].height = 820;
		frame_elements[Elements::top].width = 199;

		frame_elements[Elements::top].symbol = createSprite("data/frame/side_right.png");
		frame_elements[Elements::top].height = 820;
		frame_elements[Elements::top].width = 199;
	};
	~Frame(){};
	...
	void print_frame(int x, int y,
		...
		if (height_counter > 0)
		{
			for (int i = 0; i <= width_counter; i++)
			{
				drawSprite(frame_elements[Elements::left].symbol, x_temp, y);
		...
		if (width_counter > 0)
		{
			int x_temp = x + frame_elements[Elements::bottom].width;
			for (int i = 0; i <= width_counter; i++)
			{
				drawSprite(frame_elements[Elements::bottom].symbol, x_temp, y_temp);
		...
		if (height_counter > 0)
		{
			...
			int y_temp = y + frame_elements[Elements::right].height;
			for (int i = 0; i <= width_counter; i++)
			{
				drawSprite(frame_elements[Elements::right].symbol, x_temp, y);
		...
		{
			x_temp = x + frame_elements[Elements::center].width;
			y_temp = y + frame_elements[Elements::center].height;
